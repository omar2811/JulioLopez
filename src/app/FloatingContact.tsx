...
export default function FloatingContact() {
  const whatsappNumber = "529241383113";
  const facebookUrl = "https://www.facebook.com/share/1ApwEL6Xpy/?mibextid=wwXIfr"; // <--- CAMBIA ESTO
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="w-12 h-12 bg-[#1877F2] rounded-full flex items-center justify-center shadow-lg text-white"
      >
        <svg
